...
public class CorredoresModel {
	...
	private final static String SQL_LISTA_CORREDORES_BY_IDCARRERA = "select * from corredores c,inscripciones i"
			+ " where idcarrera = ? and c.dnicorredor = i.dnicorredor order by"
